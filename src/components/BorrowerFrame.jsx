...
import { Bell, Home, FileText, Activity, LogOut, ArrowRightLeft } from "lucide-react";
...
export function BorrowerFrame() {
  const { borrowerLink, borrowers, logout, availableRoles, switchRole } = useApp();
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="flex h-10 items-center justify-center rounded-lg bg-slate-900 px-3 text-sm font-bold text-white hover:bg-slate-800"
            >
              <ArrowRightLeft size={16} className="mr-2" /> 
              {availableRoles.includes("lender") ? "Lender App" : "Give Loan"}
            </button>
